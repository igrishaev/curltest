...
/*
 * Class:     org_example_Native
 * Method:    curl_easy_setopt_CURLOPT_READDATA_file
 * Signature: (JJ)J
 */
...
/*
 * Class:     org_example_Native
 * Method:    curl_easy_setopt_CURLOPT_READDATA_stream
 * Signature: (JJ)J
 */
...
/*
 * Class:     org_example_Native
 * Method:    init_write_data_handler
 * Signature: (Lorg/example/IWriteHandler;)J
 */
